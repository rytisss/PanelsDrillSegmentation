...
def main():
    labelsDir = r'C:\Users\Rytis\Desktop\straipsnis\training data\dataForTraining_v3\dataForTraining_v3\Label_rois/'
    ...
    cms = [viridis, twentyFivePercentCmp, fiftyFivePercentCmp]
    ...
    titles = ['100%', '<25%', '<50%']
    for [ax, cmap, title] in zip(axs, cms, titles):
        ...
        for tick in ax.yaxis.get_major_ticks():
            tick.label.set_fontsize(18)
    fig.tight_layout()
    fig.suptitle("Labeled Pixels Distribution in Dataset",fontsize = 25)
    plt.show()
